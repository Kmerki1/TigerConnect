...
function Post({ id, userId, name, tag, content, date, likes, replies, onDelete }) {
      ...
      <div className="post-header">
        ...
        <div className="post__user-container">
          ...
          <Link to={`/profile/${userId}`}>
            <span className="post__username">@{tag}</span>
          </Link>
        </div>
        <div className="delete-button">{onDelete && (
          <IconContext.Provider
            value={{ style: { fontSize: "25px", color: " #FFBB00" } }}
          >
      ...
      <div className="post-footer">
        ...
        <div className="post-likes">
          ...
          >
            <div className="widget-wrapper">
              <div
                className={`icon-wrapper ${animate ? "icon-pop" : ""}`}
                onClick={handleLike}
              >
